...
const Chatbot = () => {
  ...
  return (
    <DashboardLayout activeMenu="Chatbot">
      <div className="flex flex-col h-full min-h-screen bg-gray-50 px-4 sm:px-6 lg:px-8 py-6 overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 grid grid-cols-1 xl:grid-cols-4 gap-6 overflow-hidden">
          {/* Chat Section */}
          <div className="xl:col-span-3 flex flex-col bg-white rounded-2xl border border-gray-200 shadow-md p-5 overflow-hidden">
            {/* Messages Area */}
            ...
            <div className="mt-4 flex gap-3 items-center flex-shrink-0">
              <input
                ...
                className="flex-1 border border-gray-300 rounded-xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 transition-all"
                disabled={loading}
              />
              <button
                onClick={handleSend}
            ...
            <p className="text-xs text-gray-500 text-center mt-3 flex-shrink-0">
              Press <strong>Enter</strong> to send • For educational use only
            </p>
          </div>

          {/* Sidebar */}
          <div className="xl:col-span-1 flex flex-col bg-white rounded-2xl border border-gray-200 shadow-md p-5 overflow-hidden">
            ...
            {/* Tips */}
            <div className="mt-5 pt-4 border-t border-gray-200 flex-shrink-0">
